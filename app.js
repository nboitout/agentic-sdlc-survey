...
const surveyConfig = {
  coreQuestions: [
    ...
    { id: 'q4_productivity', type: 'single_choice', required: true, label: L('How much does AI improve your productivity?', 'Dans quelle mesure l’IA améliore-t-elle votre productivité ?'), options: [
      ...
      { value: 'rely_on_ai_for_workload', label: L('AI is essential to how I work', 'L’IA est essentielle à ma façon de travailler', 'IA este esențială pentru modul în care lucrez', 'A IA é essencial para a forma como eu trabalho') },
    ] },
    { id: 'q5_quality', type: 'single_choice', required: true, label: L('How much does AI improve the quality of your work output?', 'Dans quelle mesure l’IA améliore-t-elle la qualité de ce que vous produisez ?', 'În ce măsură îți îmbunătățește IA calitatea rezultatelor muncii tale?', 'Em que medida a IA melhora a qualidade do que você produz?'), options: [
      ...
      { value: 'moderate_improvement', label: L('Moderate improvement', 'Amélioration modérée', 'Îmbunătățire moderată', 'Melhoria moderada') },
      { value: 'significant_improvement', label: L('Significant improvement', 'Amélioration significative', 'Îmbunătățire semnificativă', 'Melhoria significativa') },
      { value: 'higher_quality_with_ai', label: L('AI is essential to achieving the quality level I expect', 'L’IA est essentielle pour atteindre le niveau de qualité que j’attends', 'IA este esențială pentru a atinge nivelul de calitate pe care îl aştept', 'A IA é essencial para alcançar o nível de qualidade que eu espero') },
    ] },
    ...
    { id: 'q7_autonomy', type: 'single_choice', required: true, label: L('What is the highest level of AI autonomy you currently use in your work?', 'Quel est le niveau d’autonomie le plus élevé que vous utilisez actuellement avec l’IA dans votre travail ?', 'Care este cel mai ridicat nivel de autonomie pe care îl folosești în prezent cu IA în activitatea ta?', 'Qual é o nível mais alto de autonomia que você utiliza atualmente com IA no seu trabalho?'), options: [
      ...
      { value: 'generates_outputs', label: L('AI generates outputs for me to review', 'L’IA génère des résultats que je révise', 'IA generează rezultate pe care le revizuiesc', 'A IA gera resultados que eu reviso') },
      { value: 'executes_tasks_with_supervision', label: L('AI executes tasks under human supervision', 'L’IA exécute des tâches sous supervision humaine', 'IA execută sarcini sub supraveghere umană', 'A IA executa tarefas sob supervisão humana') },
      { value: 'runs_workflows_end_to_end', label: L('AI runs workflows end-to-end with minimal human intervention', 'L’IA exécute des workflows de bout en bout avec une intervention humaine minimale', 'IA rulează fluxuri de lucru cap-coadă cu intervenție umană minimă', 'A IA executa fluxos de trabalho de ponta a ponta com intervenção humana mínima') },
    ] },
    { id: 'q8_async', type: 'single_choice', required: true, label: L('Can AI continue working on some tasks without your ongoing involvement?', 'L’IA peut-elle continuer à travailler sur certaines tâches sans votre implication continue ?', 'Poate IA să continue să lucreze la anumite sarcini fără implicarea ta continuă?', 'A IA pode continuar trabalhando em algumas tarefas sem o seu envolvimento contínuo?'), options: [
      ...
      { value: 'partial_handoff', label: L('Partly, AI can handle parts of a task before needing my input again', 'Partiellement, l’IA peut gérer une partie d’une tâche avant de nécessiter de nouveau mon intervention', 'IA poate gestiona părți dintr-o sarcină înainte de a avea din nou nevoie de intervenția mea', 'A IA pode lidar com partes de uma tarefa antes de precisar novamente da minha intervenção') },
      { value: 'independent_tasks', label: L('Yes, for some tasks AI can continue until completion without me', 'Oui, pour certaines tâches, l’IA peut aller jusqu’à l’achèvement sans moi', 'Da, pentru unele sarcini IA poate continua până la final fără mine', 'Sim, para algumas tarefas a IA pode ir até a conclusão sem mim') },
    ] },
  ...
  branches: {
    developer: {
      ...
      questions: [
        { id: 'd1', type: 'single_choice', required: true, label: L('To what extent do you use AI for coding?', 'Dans quelle mesure utilisez-vous l’IA pour le développement ?', 'În ce măsură folosești IA pentru programare?', 'Em que medida você usa IA para programação?'), options: [
        ...
        { id: 'd2', type: 'single_choice', required: true, label: L('How often does AI help you understand unfamiliar code?', 'À quelle fréquence l’IA vous aide-t-elle à comprendre du code non familier ?'), options: [
          { value: 'never', label: L('Never', 'Jamais') }, { value: 'occasionally', label: L('Occasionally', 'Occasionnellement') }, { value: 'frequently', label: L('Frequently', 'Fréquemment') }, { value: 'consistently', label: L('Consistently', 'De manière constante', 'În mod constant', 'De forma consistente') },
        ] },
        ...
        { id: 'd9', type: 'single_choice', required: true, label: L('How are AI agents currently used in your development workflow?', 'Comment les agents sont-ils utilisés dans votre workflow de développement ?'), options: [{ value: 'none', label: L('Not used', 'Aucun') }, { value: 'experimental', label: L('Experimental use only', 'Expérimental') }, { value: 'some_workflows', label: L('Used in some workflows', 'Utilisés dans certains workflows') }, { value: 'core_workflow', label: L('A core part of the workflow', 'Au cœur du workflow') }] },
        { id: 'd10', type: 'multi_select', required: true, label: L('Which of the following can agents currently do in your development workflow?', 'Lesquelles des actions suivantes les agents peuvent-ils actuellement réaliser dans votre workflow de développement ?', 'Care dintre următoarele pot face în prezent agenții în fluxul tău de dezvoltare?', 'Quais das seguintes ações os agentes conseguem realizar atualmente no seu fluxo de desenvolvimento?'), options: [{ value: 'open_prs', label: L('Open PRs', 'Ouvrir des PR') }, { value: 'fix_bugs', label: L('Fix bugs', 'Corriger des bugs') }, { value: 'refactor_code', label: L('Refactor code', 'Refactoriser du code') }, { value: 'update_dependencies', label: L('Update dependencies', 'Mettre à jour des dépendances') }, { value: 'maintain_documentation', label: L('Maintain documentation', 'Maintenir la documentation') }] },
...
const ptQuestionLabels = {
  ...
  q8_async: 'A IA pode continuar trabalhando em algumas tarefas sem o seu envolvimento contínuo?',
...
const ptOptionLabels = {
  ...
  suggests_only: 'A IA fornece apenas sugestões', generates_outputs: 'A IA gera resultados que eu reviso', executes_tasks_with_supervision: 'A IA executa tarefas sob supervisão humana', runs_workflows_end_to_end: 'A IA executa fluxos de trabalho de ponta a ponta com intervenção humana mínima', executes_with_supervision: 'Executa com supervisão', runs_workflows: 'Executa fluxos completos',
  continuous_involvement_required: 'Não, preciso permanecer envolvido o tempo todo', partial_handoff: 'Parcialmente, a IA pode lidar com partes de uma tarefa antes de precisar novamente da minha intervenção', independent_tasks: 'Sim, para algumas tarefas a IA pode ir até a conclusão sem mim', no: 'Não', limited_async: 'Limitado', yes_independent: 'Sim', no_measurement: 'Não é medido', informal_tracking: 'É acompanhado de forma informal', defined_metrics: 'É medido com métricas definidas',
