...
const surveyConfig = {
  ...
  branches: {
    ...
    qa_testing_quality: {
      ...
      questions: [
        { id: 'qat1', type: 'single_choice', required: true, label: L('How often do you use AI to design, generate, or refine test scenarios and test cases?', 'À quelle fréquence utilisez-vous l’IA pour concevoir, générer ou affiner des scénarios et des cas de test ?', 'Cât de des folosești IA pentru a concepe, genera sau rafina scenarii și cazuri de test?', 'Com que frequência você utiliza IA para projetar, gerar ou refinar cenários e casos de teste?'), options: [{ value: 'not_used', label: L('Not used', 'Pas utilisé', 'Nu este utilizată', 'Não utilizada') }, { value: 'occasionally', label: L('Occasionally', 'Occasionnellement', 'Ocazional', 'Ocasionalmente') }, { value: 'frequently', label: L('Frequently', 'Fréquemment', 'Frecvent', 'Frequentemente') }, { value: 'systematically', label: L('Systematically', 'Systématiquement', 'Sistematic', 'Sistematicamente') }] },
        { id: 'qat2', type: 'single_choice', required: true, label: L('How often does AI help you translate requirements or acceptance criteria into testable scenarios?', 'À quelle fréquence l’IA vous aide-t-elle à traduire des exigences ou des critères d’acceptation en scénarios testables ?', 'Cât de des te ajută IA să transformi cerințe sau criterii de acceptare în scenarii testabile?', 'Com que frequência a IA ajuda você a transformar requisitos ou critérios de aceitação em cenários testáveis?'), options: [{ value: 'not_used', label: L('Not used', 'Pas utilisé', 'Nu este utilizată', 'Não utilizada') }, { value: 'occasionally', label: L('Occasionally', 'Occasionnellement', 'Ocazional', 'Ocasionalmente') }, { value: 'frequently', label: L('Frequently', 'Fréquemment', 'Frecvent', 'Frequentemente') }, { value: 'systematically', label: L('Systematically', 'Systématiquement', 'Sistematic', 'Sistematicamente') }] },
        { id: 'qat3', type: 'single_choice', required: true, label: L('How often does AI help update, repair, or refactor automated tests and test suites?', 'À quelle fréquence l’IA vous aide-t-elle à mettre à jour, réparer ou refactorer des tests automatisés et des suites de tests ?', 'Cât de des te ajută IA să actualizezi, repari sau refactorizezi teste automate și suite de test?', 'Com que frequência a IA ajuda você a atualizar, corrigir ou refatorar testes automatizados e suítes de teste?'), options: [{ value: 'not_used', label: L('Not used', 'Pas utilisé', 'Nu este utilizată', 'Não utilizada') }, { value: 'occasionally', label: L('Occasionally', 'Occasionnellement', 'Ocazional', 'Ocasionalmente') }, { value: 'frequently', label: L('Frequently', 'Fréquemment', 'Frecvent', 'Frequentemente') }, { value: 'systematically', label: L('Systematically', 'Systématiquement', 'Sistematic', 'Sistematicamente') }] },
        { id: 'qat4', type: 'single_choice', required: true, label: L('How often does AI help identify missing coverage, edge cases, or untested scenarios?', 'À quelle fréquence l’IA vous aide-t-elle à identifier des couvertures manquantes, des cas limites ou des scénarios non testés ?', 'Cât de des te ajută IA să identifici acoperire lipsă, cazuri limită sau scenarii netestate?', 'Com que frequência a IA ajuda você a identificar cobertura ausente, casos de borda ou cenários não testados?'), options: [{ value: 'not_used', label: L('Not used', 'Pas utilisé', 'Nu este utilizată', 'Não utilizada') }, { value: 'occasionally', label: L('Occasionally', 'Occasionnellement', 'Ocazional', 'Ocasionalmente') }, { value: 'frequently', label: L('Frequently', 'Fréquemment', 'Frecvent', 'Frequentemente') }, { value: 'systematically', label: L('Systematically', 'Systématiquement', 'Sistematic', 'Sistematicamente') }] },
        { id: 'qat5', type: 'single_choice', required: true, label: L('How often does AI help detect regressions or diagnose failures in automated test runs and CI/CD pipelines?', 'À quelle fréquence l’IA vous aide-t-elle à détecter des régressions ou à diagnostiquer des échecs dans les exécutions de tests automatisés et les pipelines CI/CD ?', 'Cât de des te ajută IA să detectezi regresii sau să diagnostichezi eșecuri din rulările automate de teste și din pipeline-urile CI/CD?', 'Com que frequência a IA ajuda você a detectar regressões ou diagnosticar falhas em execuções automatizadas de testes e pipelines de CI/CD?'), options: [{ value: 'not_used', label: L('Not used', 'Pas utilisé', 'Nu este utilizată', 'Não utilizada') }, { value: 'occasionally', label: L('Occasionally', 'Occasionnellement', 'Ocazional', 'Ocasionalmente') }, { value: 'frequently', label: L('Frequently', 'Fréquemment', 'Frecvent', 'Frequentemente') }, { value: 'systematically', label: L('Systematically', 'Systématiquement', 'Sistematic', 'Sistematicamente') }] },
        { id: 'qat6', type: 'single_choice', required: true, label: L('How often does AI help identify root causes of defects, failures, or flaky tests?', 'À quelle fréquence l’IA vous aide-t-elle à identifier les causes racines de défauts, d’échecs ou de tests instables ?', 'Cât de des te ajută IA să identifici cauzele profunde ale defectelor, eșecurilor sau testelor instabile?', 'Com que frequência a IA ajuda você a identificar causas-raiz de defeitos, falhas ou testes instáveis?'), options: [{ value: 'not_used', label: L('Not used', 'Pas utilisé', 'Nu este utilizată', 'Não utilizada') }, { value: 'occasionally', label: L('Occasionally', 'Occasionnellement', 'Ocazional', 'Ocasionalmente') }, { value: 'frequently', label: L('Frequently', 'Fréquemment', 'Frecvent', 'Frequentemente') }, { value: 'systematically', label: L('Systematically', 'Systématiquement', 'Sistematic', 'Sistematicamente') }] },
        { id: 'qat7', type: 'single_choice', required: true, label: L('How often does AI help generate test data or configure test environments?', 'À quelle fréquence l’IA vous aide-t-elle à générer des données de test ou à configurer des environnements de test ?', 'Cât de des te ajută IA să generezi date de test sau să configurezi medii de test?', 'Com que frequência a IA ajuda você a gerar dados de teste ou configurar ambientes de teste?'), options: [{ value: 'not_used', label: L('Not used', 'Pas utilisé', 'Nu este utilizată', 'Não utilizada') }, { value: 'occasionally', label: L('Occasionally', 'Occasionnellement', 'Ocazional', 'Ocasionalmente') }, { value: 'frequently', label: L('Frequently', 'Fréquemment', 'Frecvent', 'Frequentemente') }, { value: 'systematically', label: L('Systematically', 'Systématiquement', 'Sistematic', 'Sistematicamente') }] },
        { id: 'qat8', type: 'single_choice', required: true, label: L('How often does AI help validate release readiness or support quality gates?', 'À quelle fréquence l’IA vous aide-t-elle à valider la préparation à la mise en release ou à soutenir les quality gates ?', 'Cât de des te ajută IA să validezi readiness-ul pentru release sau să susții quality gates?', 'Com que frequência a IA ajuda você a validar a prontidão para release ou apoiar quality gates?'), options: [{ value: 'not_used', label: L('Not used', 'Pas utilisé', 'Nu este utilizată', 'Não utilizada') }, { value: 'occasionally', label: L('Occasionally', 'Occasionnellement', 'Ocazional', 'Ocasionalmente') }, { value: 'frequently', label: L('Frequently', 'Fréquemment', 'Frecvent', 'Frequentemente') }, { value: 'systematically', label: L('Systematically', 'Systématiquement', 'Sistematic', 'Sistematicamente') }] },
        { id: 'qat9', type: 'single_choice', required: true, label: L('How often does AI help generate test reports, insights, or quality metrics?', 'À quelle fréquence l’IA vous aide-t-elle à générer des rapports de test, des insights ou des métriques de qualité ?', 'Cât de des te ajută IA să generezi rapoarte de test, insight-uri sau metrici de calitate?', 'Com que frequência a IA ajuda você a gerar relatórios de teste, insights ou métricas de qualidade?'), options: [{ value: 'not_used', label: L('Not used', 'Pas utilisé', 'Nu este utilizată', 'Não utilizada') }, { value: 'occasionally', label: L('Occasionally', 'Occasionnellement', 'Ocazional', 'Ocasionalmente') }, { value: 'frequently', label: L('Frequently', 'Fréquemment', 'Frecvent', 'Frequentemente') }, { value: 'systematically', label: L('Systematically', 'Systématiquement', 'Sistematic', 'Sistematicamente') }] },
        { id: 'qat10', type: 'multi_select', required: true, label: L('What can AI agents do today in your QA / testing workflow?', 'Que peuvent faire aujourd’hui les agents IA dans votre workflow QA / testing ?', 'Ce pot face astăzi agenții IA în fluxul tău QA / testing?', 'O que os agentes de IA conseguem fazer hoje no seu fluxo de QA / testes?'), options: [{ value: 'generate_refine_tests', label: L('Generate or refine tests', 'Générer ou affiner des tests', 'Genera sau rafina teste', 'Gerar ou refinar testes') }, { value: 'execute_tests', label: L('Execute tests or test suites', 'Exécuter des tests ou des suites de tests', 'Executa teste sau suite de teste', 'Executar testes ou suítes de teste') }, { value: 'diagnose_failures', label: L('Diagnose failures or CI/CD issues', 'Diagnostiquer des échecs ou des problèmes CI/CD', 'Diagnostica eșecuri sau probleme CI/CD', 'Diagnosticar falhas ou problemas de CI/CD') }, { value: 'suggest_fixes', label: L('Suggest fixes to tests or application code', 'Suggérer des corrections sur les tests ou le code applicatif', 'Sugera remedieri pentru teste sau codul aplicației', 'Sugerir correções em testes ou no código da aplicação') }, { value: 'maintain_test_suites', label: L('Maintain or refactor existing test suites', 'Maintenir ou refactorer des suites de tests existantes', 'Menține sau refactoriza suite de test existente', 'Manter ou refatorar suítes de teste existentes') }, { value: 'support_release_validation', label: L('Support release validation or quality gates', 'Soutenir la validation de release ou les quality gates', 'Susține validarea release-ului sau quality gates', 'Apoiar a validação de release ou quality gates') }, { value: 'generate_reports_metrics', label: L('Generate reports or quality insights', 'Générer des rapports ou des insights qualité', 'Genera rapoarte sau insight-uri de calitate', 'Gerar relatórios ou insights de qualidade') }, { value: 'iterative_loops', label: L('Run iterative loops (generate → test → fix → re-run)', 'Exécuter des boucles itératives (générer → tester → corriger → relancer)', 'Rula bucle iterative (generează → testează → repară → rulează din nou)', 'Executar loops iterativos (gerar → testar → corrigir → executar novamente)') }, { value: 'no_ai_agents_qa', label: L('I do not use AI agents in QA/testing', 'Je n’utilise pas d’agents IA en QA/testing', 'Nu folosesc agenți IA în QA/testing', 'Não utilizo agentes de IA em QA/testes') }] },
        { id: 'qat11', type: 'multi_select', required: true, label: L('Which AI tools or platforms do you currently use for QA / testing?', 'Quels outils ou plateformes d’IA utilisez-vous actuellement pour la QA / le testing ?', 'Ce instrumente sau platforme de IA folosești în prezent pentru QA / testing?', 'Quais ferramentas ou plataformas de IA você utiliza atualmente para QA / testes?'),
          helperText: L(
            'Please select the tools or platforms you use directly in your QA/testing workflow, not the underlying AI models.',
            'Merci de sélectionner les outils ou plateformes que vous utilisez directement dans votre workflow QA/testing, et non les modèles d’IA sous-jacents.',
            'Te rugăm să selectezi instrumentele sau platformele pe care le folosești direct în fluxul tău QA/testing, nu modelele IA de bază.',
            'Selecione as ferramentas ou plataformas que você utiliza diretamente no seu fluxo de QA/testes, e não os modelos de IA subjacentes.'
          ),
          options: [{ value: 'github_copilot_testing', label: L('GitHub Copilot (testing / automation)', 'GitHub Copilot (testing / automation)', 'GitHub Copilot (testing / automation)', 'GitHub Copilot (testing / automation)') }, { value: 'claude_code', label: L('Claude Code', 'Claude Code', 'Claude Code', 'Claude Code') }, { value: 'openai_codex', label: L('OpenAI Codex', 'OpenAI Codex', 'OpenAI Codex', 'OpenAI Codex') }, { value: 'cursor', label: L('Cursor', 'Cursor', 'Cursor', 'Cursor') }, { value: 'playwright_cypress_selenium_ai', label: L('Playwright / Cypress / Selenium (with AI usage)', 'Playwright / Cypress / Selenium (avec usage de l’IA)', 'Playwright / Cypress / Selenium (cu utilizare IA)', 'Playwright / Cypress / Selenium (com uso de IA)') }, { value: 'postman_rest_assured_api_ai', label: L('Postman / REST Assured / API testing tools', 'Postman / REST Assured / outils de test API', 'Postman / REST Assured / instrumente de testare API', 'Postman / REST Assured / ferramentas de teste de API') }, { value: 'cicd_tools_ai', label: L('CI/CD tools (Jenkins / GitHub Actions / GitLab CI)', 'Outils CI/CD (Jenkins / GitHub Actions / GitLab CI)', 'Instrumente CI/CD (Jenkins / GitHub Actions / GitLab CI)', 'Ferramentas de CI/CD (Jenkins / GitHub Actions / GitLab CI)') }, { value: 'katalon', label: L('Katalon', 'Katalon', 'Katalon', 'Katalon') }, { value: 'testsigma', label: L('Testsigma', 'Testsigma', 'Testsigma', 'Testsigma') }, { value: 'accelq', label: L('ACCELQ', 'ACCELQ', 'ACCELQ', 'ACCELQ') }, { value: 'mabl', label: L('mabl', 'mabl', 'mabl', 'mabl') }, { value: 'kaneai_testmu_ai', label: L('KaneAI / TestMu AI', 'KaneAI / TestMu AI', 'KaneAI / TestMu AI', 'KaneAI / TestMu AI') }, { value: 'tricentis_tosca', label: L('Tricentis Tosca', 'Tricentis Tosca', 'Tricentis Tosca', 'Tricentis Tosca') }, { value: 'uipath_test_suite_cloud', label: L('UiPath Test Suite / Test Cloud', 'UiPath Test Suite / Test Cloud', 'UiPath Test Suite / Test Cloud', 'UiPath Test Suite / Test Cloud') }, { value: 'other_qa_ai_tools', label: L('Other QA AI tools', 'Autres outils IA pour la QA/le testing', 'Alte instrumente IA pentru QA/testing', 'Outras ferramentas de IA para QA/testes') }, { value: 'no_ai_tools_qa', label: L('I do not use AI tools for QA/testing', 'Je n’utilise pas d’outils IA pour la QA/le testing', 'Nu folosesc instrumente IA pentru QA/testing', 'Não utilizo ferramentas de IA para QA/testes') }] },
        { id: 'qat12', type: 'multi_select', required: true, label: L('How are these QA/testing AI tools adopted in your environment?', 'Comment ces outils IA de QA/testing sont-ils adoptés dans votre environnement ?', 'Cum sunt adoptate aceste instrumente IA de QA/testing în mediul tău?', 'Como essas ferramentas de IA para QA/testes são adotadas no seu ambiente?'), options: [{ value: 'personally_chosen', label: L('Some are chosen individually', 'Certains sont choisis individuellement', 'Unele sunt alese individual', 'Algumas são escolhidas individualmente') }, { value: 'informal_team_use', label: L('Some are used informally within the team', 'Certains sont utilisés de manière informelle dans l’équipe', 'Unele sunt folosite informal în cadrul echipei', 'Algumas são utilizadas informalmente na equipe') }, { value: 'team_or_project_standard', label: L('Some are standardized at team or project level', 'Certains sont standardisés au niveau de l’équipe ou du projet', 'Unele sunt standardizate la nivel de echipă sau proiect', 'Algumas são padronizadas no nível da equipe ou do projeto') }, { value: 'client_mandated', label: L('Some are mandated by the client', 'Certains sont imposés par le client', 'Unele sunt impuse de client', 'Algumas são impostas pelo cliente') }, { value: 'company_standard', label: L('Some are standardized at company level', 'Certains sont standardisés au niveau de l’entreprise', 'Unele sunt standardizate la nivelul companiei', 'Algumas são padronizadas no nível da empresa') }, { value: 'trial_experimental', label: L('Some are still in trial or experimental use', 'Certains sont encore en phase de test ou d’expérimentation', 'Unele sunt încă în fază de test sau utilizare experimentală', 'Algumas ainda estão em fase de teste ou uso experimental') }] },
      ],
    },
...
function App() {
  ...
  const toggleMulti = (id, value) => setAnswers((prev) => {
    ...
    if (id === 'q3_general_tools' || id === 'q11_learning_path' || id === 'd11' || id === 'qat10' || id === 'qat11') {
      const exclusiveValue = id === 'q3_general_tools'
        ? 'no_general_ai_tools'
        : (id === 'q11_learning_path'
          ? 'no_learning_effort'
          : (id === 'd11' ? 'no_coding_agents' : (id === 'qat10' ? 'no_ai_agents_qa' : 'no_ai_tools_qa')));
            ...
            {current.type === 'free_text' ? (
              ...
              <div className="options">
                {current.options.map((option) => {
                  ...
                  const noQaAgentsSelected = current.id === 'qat10' && Array.isArray(answers[current.id]) && answers[current.id].includes('no_ai_agents_qa');
                  const noQaToolsSelected = current.id === 'qat11' && Array.isArray(answers[current.id]) && answers[current.id].includes('no_ai_tools_qa');
                  const disabled = (current.id === 'q3_general_tools' && noGeneralToolsSelected && option.value !== 'no_general_ai_tools')
                    ...
                    || (current.id === 'qat10' && noQaAgentsSelected && option.value !== 'no_ai_agents_qa')
                    || (current.id === 'qat11' && noQaToolsSelected && option.value !== 'no_ai_tools_qa');
                  return (
